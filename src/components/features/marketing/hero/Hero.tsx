...
const _Hero = (): JSX.Element => {
    ...
    useEffect(() => {
        if (mounted && !formData.travelDate) {
            ...
            setFormData(_prev => ({ ..._prev, travelDate: _today }));
        }
    ...
    const handleFormChange = (_e: React.ChangeEvent<HTMLSelectElement | HTMLInputElement>) => {
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        >
                                            {Array.from({ length: 24 }).map((_, i): JSX.Element => (
