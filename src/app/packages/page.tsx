...
[The complete content of the file from line
  'All Cities',
    'Mumbai',
    'Delhi',
    'Bangalore',
                ...
                <div className="container mx-auto px-4">
                    <div className="flex overflow-x-auto py-2 space-x-4">
                        <button
                            ...
                            className={`px-4 py-2 font-medium whitespace-nowrap ${activeTab === 'hourly'
                        ...
                        <button
                            ...
                            className={`px-4 py-2 font-medium whitespace-nowrap ${activeTab === 'tour'
                                    ? 'text-green-700 border-b-2 border-green-700'
                                    : 'text-gray-600 hover:text-green-700'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-2 font-medium whitespace-nowrap ${activeTab === 'corporate'
                                    ? 'text-green-700 border-b-2 border-green-700'
                                    : 'text-gray-600 hover:text-green-700'
                                }`}
                        >
                        ...
                        <div className="flex flex-wrap justify-center gap-2 mb-8">
                            {cities.map(city => (
                                <button
                                    ...
                                    className={`px-4 py-1 rounded-full text-sm ${selectedCity === city
