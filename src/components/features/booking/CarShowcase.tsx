...
const CarShowcase = React.memo((): JSX.Element => {
    ...
    const _visibleCars = filteredCars.slice(
        ...
        <div className="py-12 bg-gray-50">
            <div className="container mx-auto px-4">
                ...
                <div className="flex justify-center mb-6 space-x-2">
                    {["all", "economy", "premium", "suv", "luxury"].map((category): JSX.Element => (
                        <button
                            key={category}
                ...
                <div className="relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
                        {_visibleCars.map((car): JSX.Element => (
                            <Card
                                key={car.id}
                                ...
                                <div className="p-5">
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <ul className="grid grid-cols-2 gap-x-2 gap-y-1">
                                            {car.features.map((_feature, index): JSX.Element => (
                                                <li
                                                    key={index}
                    ...
                    {totalSlides > 1 && (
                        <div className="flex justify-center space-x-2 mt-8">
                            {Array.from({ length: totalSlides }).map((_, index): JSX.Element => (
                                <button
                                    key={index}
