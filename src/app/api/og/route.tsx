...
export async function GET(request: NextRequest) {
  try {
    ...
    const title = searchParams.get('title') || 'IndiCab - Outstation Cab Service';
    const description = searchParams.get('description') || 'Book cabs for one-way and round trips across India';
