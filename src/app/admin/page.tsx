...
export default function AdminDashboard(): JSX.Element {
    ...
    const _getDriverStatusBadge = (status: string): JSX.Element => {
        switch (status) {
            case 'Available':
                return <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                    <CheckCircle className="w-3 h-3 mr-1" />
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                {_stats.map((stat, _i): JSX.Element => (
                    <Card key={_i}>
                        ...
                        <CardContent>
                            <div className="overflow-x-auto">
                                <table className="w-full text-sm">
                                    ...
                                    <tbody>
                                        {_recentBookings.map((booking): JSX.Element => (
                                            <tr key={booking.id} className="border-b hover:bg-gray-50">
                                                ...
                                                <td className="py-3 px-2">{_getStatusBadge(booking.status)}</td>
                                                <td className="py-3 px-2">
                    ...
                    <Card className="h-full">
                        ...
                        <CardContent>
                            <div className="space-y-4">
                                {_activeDrivers.map((driver): JSX.Element => (
                                    <div key={driver.id} className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50">
                                        ...
                                        <div className="text-right">
                                            <div className="mb-1">
                                                {_getDriverStatusBadge(driver.status)}
                                            </div>
